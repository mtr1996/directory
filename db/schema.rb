...
ActiveRecord::Schema.define(version: 20170512163244) do
  ...
  create_table "forms", force: :cascade do |t|
    t.text     "user_description",        null: false
    t.text     "hobbies",                 null: false
    t.text     "bad_habits",              null: false
    t.text     "type_of_home",            null: false
    t.text     "purpose_of_acquaintance", null: false
    t.integer  "user_id"
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
  end

  add_index "forms", ["user_id"], name: "index_forms_on_user_id", unique: true, using: :btree
  ...
  create_table "servises", force: :cascade do |t|
  ...
  add_index "servises", ["user_id"], name: "index_servises_on_user_id", using: :btree
  ...
  add_foreign_key "servises", "users"
end
