class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :login, :sex, :birthday, :country, :city, :email, :password, :password_confirmation, 
        :activation_state, :activation_token, :activation_token_expires_at,
        form_attributes: [:user_description, :user_id, :hobbies, :bad_habits, :type_of_home, :purpose_of_acquaintance],
      # nested_start
